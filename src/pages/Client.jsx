...
// COMPONENTE DE REACT
function Client() {
	const [isActiveClient, setActiveClient] = useState([true, false, false, false]);
    ...
    // temporal
    const dataHistorial = [
        {fecha:"12/6/2023", monto:500, factura:"0123456"},
        {fecha:"11/6/2023", monto:100, factura:"2345678"},
        {fecha:"10/6/2023", monto:200, factura:"3456789"},
    ]
				...
				<div id="button-group" className="flex flex-row gap-2 justify-center">
					<button
						...
						className={`px-6 py-1 text-xl rounded-md ${
							isActiveClient[0] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
						}`}>
						TIPO A
					</button>
					...
					<button
						...
						className={`px-6 py-1 text-xl rounded-md ${
							isActiveClient[1] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
						}`}>
						ULTIMAS COMPRAS
					</button>
					...
					<button
						...
						className={`px-6 py-1 text-xl rounded-md ${
							isActiveClient[2] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
						}`}>
						ITEM MAS COMPRADOS
					</button>
					<button
						...
						className={`px-6 py-1 text-xl rounded-md ${
							isActiveClient[3] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
						}`}>
						CREDITOS Y COBRANZAS
					</button>
				</div>
				<div id="content">
					<div id="content-0" className={`${isActiveClient[0] ? 'flex flex-row' : 'hidden'}`}>
					...
					<div id="content-1" className={`${isActiveClient[1] ? 'flex' : 'hidden'}`}>
						Texto 2
					</div>
					<div id="content-2" className={`${isActiveClient[2] ? 'flex' : 'hidden'}`}>
						Texto 3
					</div>
					<div id="content-3" className={`${isActiveClient[3] ? 'flex' : 'hidden'}`}>
						Texto 4
					</div>
				</div>
			</div>
			...
			<div id="tabs" className="flex flex-col gap-4 p-4">
				<div id="button-group" className="flex flex-row gap-2 justify-center">
					<button
						...
						className={`px-6 py-1 text-xl rounded-md ${
							isActiveItem[0] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
						}`}>
						TD
					</button>
					<button
						...
						className={`px-6 py-1 text-xl rounded-md ${
							isActiveItem[1] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
						}`}>
						S.I
					</button>
					<button
						...
						className={`px-6 py-1 text-xl rounded-md ${
							isActiveItem[2] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
						}`}>
						PH
					</button>
				</div>
				<div id="content">
					<div id="content-4" className={`${isActiveItem[0] ? 'flex' : 'hidden'}`}>
						Texto 5
					</div>
					<div id="content-5" className={`${isActiveItem[1] ? 'flex' : 'hidden'}`}>
						Texto 6
					</div>
					<div id="content-6" className={`${isActiveItem[2] ? 'flex' : 'hidden'}`}>
						Texto 7{' '}
					</div>
				</div>
			</div>
