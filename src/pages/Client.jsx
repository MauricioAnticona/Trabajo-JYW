					...
					<div id="button-group" className="flex flex-row gap-2 justify-center">
						<button
							...
							className={`px-6 py-1 text-xl rounded-md ${
								isActiveTabClient[0] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
							}`}>
							TIPO A
						</button>
						...
						<button
							...
							className={`px-6 py-1 text-xl rounded-md ${
								isActiveTabClient[1] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
							}`}>
							ULTIMAS COMPRAS
						</button>
						...
						<button
							...
							className={`px-6 py-1 text-xl rounded-md ${
								isActiveTabClient[2] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
							}`}>
							ITEM MAS COMPRADOS
						</button>
						<button
							...
							className={`px-6 py-1 text-xl rounded-md ${
								isActiveTabClient[3] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
							}`}>
				...
				<div id="tabs" className="flex flex-col gap-4 p-4">
					<div id="button-group" className="flex flex-row gap-2 justify-center">
						<button
							...
							className={`px-6 py-1 text-xl rounded-md ${
								isActiveTabItem[0] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
							}`}>
							TD
						</button>
						<button
							...
							className={`px-6 py-1 text-xl rounded-md ${
								isActiveTabItem[1] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
							}`}>
							S.I
						</button>
						<button
							...
							className={`px-6 py-1 text-xl rounded-md ${
								isActiveTabItem[2] ? 'bg-blue-800 text-white' : 'bg-gray-200 text-black'
							}`}>
							PH
						</button>
					</div>
